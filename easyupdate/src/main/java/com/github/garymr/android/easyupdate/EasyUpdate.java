...
public final class EasyUpdate {
    ...
    public static void initialize(EasyUpdateConfig config) {
        Util.checkNotNull(config, "EasyUpdateConfig is null");
        Util.checkNotNull(config.getUpdatePlugin(), "UpdatePlugin was not seted!");
    ...
    public static void silentUpdate(final Context context) {
        Util.checkNotNull(config, "EasyUpdate was not initialized!");
        Util.checkNotNull(context, "Context is null");
